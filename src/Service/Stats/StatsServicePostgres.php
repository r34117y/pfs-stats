...
ORDER BY
    ...
    public function getAvgPointsPerGame(int $orgId): AvgPointsPerGame
    {
        ...
        $rows = $this->fetchAllAssociativeCompat(
            ...
            ORDER BY ROUND(AVG(ps.score), 4) DESC, p.name_show ASC",
            [
                'last24MonthsDate' => $last24MonthsDateInt,
                'last12MonthsDate' => $last12MonthsDateInt,
            ]
    ...
    public function getAvgOpponentsPointsPerGame(): AvgOpponentsPointsPerGame
    {
        ...
        $rows = $this->fetchAllAssociativeCompat(
            ...
            ORDER BY last24MonthsAverageOpponentPoints DESC NULLS LAST, playerName ASC",
            [
                'last24MonthsDate' => $last24MonthsDateInt,
                'last12MonthsDate' => $last12MonthsDateInt,
            ]
    ...
    public function getAvgPointsDifferencePerGame(): AvgPointsDifferencePerGame
    {
        ...
        $rows = $this->fetchAllAssociativeCompat(
            ...
            ORDER BY last24MonthsAveragePointsDifference DESC NULLS LAST, playerName ASC",
            [
                'last24MonthsDate' => $last24MonthsDateInt,
                'last12MonthsDate' => $last12MonthsDateInt,
            ]
    ...
    public function getGamesOver400(): GamesOver400
    {
        ...
        $rows = $this->fetchAllAssociativeCompat(
            ...
            FROM stats s
            ORDER BY gamesOver40024MonthsPercent DESC NULLS LAST, playerName ASC",
            [
                'last24MonthsDate' => $last24MonthsDateInt,
                'last12MonthsDate' => $last12MonthsDateInt,
            ]
    ...
    public function getHighestRank(): HighestRank
    {
        ...
        $rows = $this->fetchAllAssociativeCompat(
            ...
            ORDER BY highestRank24Months DESC NULLS LAST, gs.playerName ASC",
            [
                'last24MonthsDate' => $last24MonthsDateInt,
                'last12MonthsDate' => $last12MonthsDateInt,
            ]
